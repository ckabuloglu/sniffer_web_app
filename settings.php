    ...
    <div class="container-fluid">
        ...
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li id="li_email" class="active"><a class="sidebar_item" id="menu_email" href="#email"><i class="fa fa-envelope fa-2x"></i> &nbsp Email </a></li>
            <li id="li_password"><a class="sidebar_item" id="menu_password" href="#password"><i class="fa fa-lock fa-2x"></i> &nbsp Password </a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" id="div_container">
            <div class="main_element" id="email">
                <h1> Change email settings are under construction ... </h1>
            </div>

            <div class="main_element" id="password" style="display:none;">
                <h1> Change password settings are under construction ... </h1>
            </div>
        </div>
